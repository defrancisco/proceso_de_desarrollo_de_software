...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Host de BD en módulo usuarios: " + configModuloUsuarios.getValue("db_host"));
        ...
        System.out.println("Host de BD en módulo pagos: " + configModuloPagos.getValue("db_host"));

        // Demostración de consistencia: Modificamos el valor desde un "objeto"
        System.out.println("\n=== Modificando el puerto desde el módulo de pagos... ===");
        configModuloPagos.setValue("db_port", "5432");

        // El cambio se refleja en el otro "objeto" porque cambian lo mismo en memoria
        System.out.println("Puerto de BD visto desde módulo usuarios: " + configModuloUsuarios.getValue("db_port"));
